...
export const setBookAsFinished = createAction(
  '[Reading List API] Set book as finished',
  props<{ item: ReadingListItem }>()
);

export const successSetBookAsFinished = createAction(
  '[Reading List API] Success set book as finished',
  props<{ item: ReadingListItem }>()
);
export const failedSetBookAsFinished = createAction(
  '[Reading List API] Failed set book as finished',
  props<{ item: ReadingListItem }>()
);
